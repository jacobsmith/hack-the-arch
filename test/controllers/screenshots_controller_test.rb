...
class ScreenshotsControllerTest < ActionController::TestCase
  ...
  test "should create screenshot" do
    assert_difference('Screenshot.count') do
      post :create, screenshot: { file: @screenshot.file, report_id: @screenshot.report_id, vulnerability_id: @screenshot.vulnerability_id }
    end
  ...
  test "should update screenshot" do
    patch :update, id: @screenshot, screenshot: { file: @screenshot.file, report_id: @screenshot.report_id, vulnerability_id: @screenshot.vulnerability_id }
    assert_redirected_to screenshot_path(assigns(:screenshot))
  end
